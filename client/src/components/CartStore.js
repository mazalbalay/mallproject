    ...
    <div className="w-80 border border-gray">
      ...
      <div className="flex justify-end bg-gray-200">
        ...
        <div className="right-img bg-gray-200 ">
          <img
            className="w-24 rounded-full p-3"
            src="https://www.nahariya-link.co.il/media-lib/portal2_business6174_mini_site_logo.png"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="flex">
        ...
        <div className="right-img ">
          <img
            className="w-24"
            src="https://d3m9l0v76dty0.cloudfront.net/system/photos/4848165/index/5a10b2f72e336601e5bdb787310aae1d.jpg"
            alt=""
          />
        </div>
      </div>
