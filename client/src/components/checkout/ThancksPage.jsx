...
<<<<<<< HEAD
    <div className=" w-full md:w-2/3 p-10 flex flex-col items-center justify-between bg-white my-1">
      <div className="w-full md:w-2/3 h-screen flex flex-col items-center justify-center">
        <div className="w-full h-1/3 flex flex-col text-center items-center justify-evenly">
=======
...
<<<<<<< HEAD
          className="bg-cyan-600 rounded-md text-white py-4 px-8  m-1 w-full md:w-1/3">
=======
